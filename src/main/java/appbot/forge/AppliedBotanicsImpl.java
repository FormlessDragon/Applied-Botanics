...
public enum AppliedBotanicsImpl implements AppliedBotanics {
    ...
    @Override
    public Lookup<MEStorage, EnumFacing> meStorage(WorldServer world, BlockPos pos) {
        return side -> {
    ...
    @Override
    public Lookup<IManaReceiver, EnumFacing> manaReceiver(WorldServer world, BlockPos pos) {
        return side -> {
            TileEntity tile = world.getTileEntity(pos);
