...
public final class ABItems {
    ...
    public static final ManaCellItem MANA_CELL_1K = item("mana_cell_1k",
            new ManaCellItem(Objects.requireNonNull(AEItems.CELL_COMPONENT_1K.item()), 1, 0.5f));
    public static final ManaCellItem MANA_CELL_4K = item("mana_cell_4k",
            new ManaCellItem(Objects.requireNonNull(AEItems.CELL_COMPONENT_4K.item()), 4, 1.0f));
    public static final ManaCellItem MANA_CELL_16K = item("mana_cell_16k",
            new ManaCellItem(Objects.requireNonNull(AEItems.CELL_COMPONENT_16K.item()), 16, 1.5f));
    public static final ManaCellItem MANA_CELL_64K = item("mana_cell_64k",
            new ManaCellItem(Objects.requireNonNull(AEItems.CELL_COMPONENT_64K.item()), 64, 2.0f));
    public static final ManaCellItem MANA_CELL_256K = item("mana_cell_256k",
            new ManaCellItem(Objects.requireNonNull(AEItems.CELL_COMPONENT_256K.item()), 256, 2.5f));

    public static final PortableManaCellItem PORTABLE_MANA_CELL_1K = item("portable_mana_cell_1k",
            new PortableManaCellItem(1, 0.5));
    public static final PortableManaCellItem PORTABLE_MANA_CELL_4K = item("portable_mana_cell_4k",
            new PortableManaCellItem(4, 1.0));
    public static final PortableManaCellItem PORTABLE_MANA_CELL_16K = item("portable_mana_cell_16k",
            new PortableManaCellItem(16, 1.5));
    public static final PortableManaCellItem PORTABLE_MANA_CELL_64K = item("portable_mana_cell_64k",
            new PortableManaCellItem(64, 2.0));
    public static final PortableManaCellItem PORTABLE_MANA_CELL_256K = item("portable_mana_cell_256k",
    ...
    public static void init() {
        ...
        registerAttunementBridge(manaP2PAttunementTag, Objects.requireNonNull(ModBlocks.pool.getRegistryName()));
        registerAttunementBridge(manaP2PAttunementTag, Objects.requireNonNull(ModBlocks.spreader.getRegistryName()));
        registerAttunementBridge(manaP2PAttunementTag, Objects.requireNonNull(ModBlocks.distributor.getRegistryName()));
        registerAttunementBridge(manaP2PAttunementTag, Objects.requireNonNull(ModBlocks.manaVoid.getRegistryName()));
        ...
        for (Tier tier : Tier.values()) {
            ...
            Upgrades.add(AEItems.VOID_CARD.item(), portable, 1, GuiText.PortableCells.getTranslationKey());
    ...
    private static void registerStorageCellModels() {
        StorageCellModels.registerModel(MANA_CELL_CREATIVE, AppliedBotanics.id("block/drive/cells/creative_cell"));
        for (Tier tier : Tier.values()) {
            var cell = get(tier);
            var portable = getPortable(tier);
            var id = AppliedBotanics.id("block/drive/cells/" + Objects.requireNonNull(cell.getRegistryName()).getPath());
